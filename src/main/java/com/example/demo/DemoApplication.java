...
//        System.out.println("["+maxId+"]"+" = "+max);
        ...
        int c=1;
        for (int i = 0; i < cities2.size()+1; i++) {
            if(cities2.get(i+1).region.equals(cities2.get(i).region)){
                c++;

            }
            else {
                System.out.println(cities2.get(i).region+" - "+c);
                c=1;
            }
        }
